...
structure Mapping = struct
	...
	(* lookup(d,M) finds the renage value r such that
		(d,r) is a pair in the mapping.*)
...
val r1 = Rational1.make_frac(1,2)
val r2 = Rational1.make_frac(6,3)
val r3 = Rational1.Whole(6)

val t1 = Rational2.make_frac(1,2)
val t2 = Rational2.make_frac(6,3)
val t3 = Rational2.Whole(6)

val s1 = Rational3.make_frac(1,2)
val s2 = Rational3.make_frac(6,3)
val s3 = Rational3.Whole(6)